...
const TenPlayerForm = (props) => {
    ...
    return (
        <div>
            <Box minHeight={1050} width={{xs: 350, sm: 500, md:700, lg:800}} >
            <Paper elevation={24} sx={{minHeight: 1050, width: '100%', borderRadius: 3, opacity:'92%', pb:2}}>
